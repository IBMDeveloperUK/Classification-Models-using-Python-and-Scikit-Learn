...
## For a comparative study of some of the current most popular algorithms Please refer to this! [Sign up](https://developer.ibm.com/tutorials/learn-classification-algorithms-using-python-and-scikit-learn/)
